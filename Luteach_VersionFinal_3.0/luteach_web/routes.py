...
from luteach_web.forms import FormDeRegistros, LoginForm, UpdateAccountForm, LearnForm, TeachForm
from luteach_web.models import User
from luteach_web import application, db, bcrypt
...
@application.route("/teach", methods=['GET', 'POST'])
@login_required
def new_teach():
    form = TeachForm()
    if form.validate_on_submit():
